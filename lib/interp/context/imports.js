 ...
 */
var getFileImports = function (r, f) {
    return (0, future_1.parallel)(f.directives.map(function (d) { return (d instanceof ast.Property) ?
...
var getListImports = function (r) { return function (l) {
    return (0, future_1.parallel)(l.elements.map(function (e) { return getValueImports(r, e); }))
        .map(function (is) { return is.reduce(record_1.merge, {}); });
}; };
var getDictImports = function (r) { return function (d) {
    return (0, future_1.parallel)(d.properties.map(function (p) { return getValueImports(r, p.value); }))
        .map(function (is) { return is.reduce(record_1.merge, {}); });
}; };
