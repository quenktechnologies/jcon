...
var Pending = /** @class */ (function () {
    ...
    Pending.prototype.descend = function (path) {
        return new Pending(this.global, this.parser, this.loader.create((0, path_1.dirname)(path)));
    };
    /**
...
var toFileContext = function (ctx, file) {
    return (0, imports_1.getFileImports)(ctx.loader, file)
...
var getIncludes = function (ctx, f) {
    return (0, future_1.parallel)(f.includes.map(getInclude(ctx)));
};
