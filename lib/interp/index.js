...
exports.interpValue = exports.interpDirective = exports.interpFile = exports.interp = void 0;
var ast = require("../ast");
...
var interpProperty = function (ctx, p) {
    return exports.interpValue(ctx, p.value)
        .chain(function (value) { return future_1.pure(property_seek_1.set(flatPath(p.path), value, {})); });
};
...
var dict2TS = function (ctx) { return function (d) {
    return d
        ...
        return exports.interpValue(ctx, c.value)
            .map(function (value) { return property_seek_1.set(c.key.value, value, o); });
    }); }, future_1.pure({}));
}; };
