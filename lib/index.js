...
exports.code = function (n) {
    if (n instanceof nodes.File) {
        ...
        return "((function(m) { " +
            (" return " + (n.member ? 'm.' + exports.code(n.member) : 'typeof m.default === \'function\' ? m.default:m') + " })") +
            ("(require(" + exports.code(n.module) + ")))");
    }
    else if (n instanceof nodes.EnvVar) {
        return "process.env['" + exports.code(n.key) + "']";
    }
    else if (n instanceof nodes.Call) {
        var m = exports.code(n.module);
