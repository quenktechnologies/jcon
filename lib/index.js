...
exports.parseDefault = exports.parse = exports.tree = void 0;
 ...
 */
exports.tree = {
    File: ast_1.File, Include: ast_1.Include, Comment: ast_1.Comment, Property: ast_1.Property, Member: ast_1.Member, Var: ast_1.Var, EnvVar: ast_1.EnvVar, Filter: ast_1.Filter, List: ast_1.List, Dict: ast_1.Dict, Pair: ast_1.Pair,
 ...
 */
exports.parseDefault = function (src) {
    return exports.parse(src, exports.tree);
};
