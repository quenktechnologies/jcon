...
case 2:
    /*! Production::    file : includes directives EOF */
...
case 3:
    /*! Production::    file : directives EOF */
...
case 8:
    /*! Production::    directives : comment */
case 9:
    /*! Production::    directives : property */
case 14:
    /*! Production::    path : identifier */
case 15:
    /*! Production::    path : string_literal */
case 33:
    /*! Production::    parameters : value */
case 42:
    /*! Production::    value_list : value */
case 63:
    /*! Production::    dict_repetition_plus : property */
...
case 10:
    /*! Production::    directives : directives comment */
case 11:
    /*! Production::    directives : directives property */
...
case 12:
    ...
    this.$ = new yy.ast.Comment(yyvstack[yysp].slice(2), this._$);
    break;

case 13:
    /*! Production::    property : path "=" value */
...
case 17:
    /*! Production::    path : path "." string_literal */
case 34:
    /*! Production::    parameters : parameters "," value */
case 38:
...
case 19:
    /*! Production::    member : module "#" identifier */
    ...
    this.$ = new yy.ast.Member(yyvstack[yysp - 2], yyvstack[yysp], false, [], this._$);
    break;
...
case 20:
    ...
    this.$ = new yy.ast.Member(yyvstack[yysp - 4], yyvstack[yysp - 2], true, [], this._$);
    break;

case 21:
    /*! Production::    member : module "#" identifier "(" parameters ")" */
    ...
    this.$ = new yy.ast.Member(yyvstack[yysp - 5], yyvstack[yysp - 3], true, yyvstack[yysp - 1], this._$);
    break;
...
case 24:
    /*! Production::    uri : ORG */
case 25:
    /*! Production::    uri : IDENTIFIER */
case 26:
    /*! Production::    uri : URIPATH */
case 51:
    /*! Production::    value_group : member */
case 52:
    /*! Production::    value_group : var */
case 53:
    /*! Production::    value_group : envvar */
case 54:
    /*! Production::    value_group : list */
case 55:
    /*! Production::    value_group : dict */
case 56:
    /*! Production::    value_group : string_literal */
case 57:
    /*! Production::    value_group : number_literal */
case 58:
    /*! Production::    value_group : boolean_literal */
case 60:
    /*! Production::    var_option : filters */
case 62:
    /*! Production::    envvar_option : filters */
...
case 28:
    /*! Production::    uri : uri "/" ".." */
case 29:
    /*! Production::    uri : uri "/" ORG */
case 30:
    /*! Production::    uri : uri "/" IDENTIFIER */
case 31:
    /*! Production::    uri : uri "/" URIPATH */
...
case 32:
    ...
    this.$ = new yy.ast.Module(yyvstack[yysp], this._$);
    break;

case 35:
    /*! Production::    var : "$(" identifier var_option ")" */
    ...
    this.$ = new yy.ast.Var(yyvstack[yysp - 2], yyvstack[yysp - 1]||[], this._$);
    break;

case 36:
    /*! Production::    envvar : "${" identifier envvar_option "}" */
    ...
    this.$ = new yy.ast.EnvVar(yyvstack[yysp - 2], yyvstack[yysp - 1]||[], this._$);
    break;
...
case 45:
    /*! Production::    dict : "{" dict_repetition_plus "}" */
...
case 59:
    /*! Production::    var_option : %epsilon */
case 61:
    /*! Production::    envvar_option : %epsilon */
...
case 64:
    /*! Production::    dict_repetition_plus : dict_repetition_plus property */
...
parse: function parse(input) {
    ...
    var NO_ACTION = [0, 90 /* === table.length :: ensures that anyone using this new state will fail dramatically! */];
...
EOF: 1,
    ...
    rules: [
      ...
      /*  5: */  /^(?:([$A-Z_a-z][\w$]*))/,
      /*  6: */  /^(?:([$A-Z_a-z][\w$\-]*))/,
      /*  7: */  /^(?:(("(?:([^\n\r"\\]+)|(\\(?:(?:(?:["'\\bfnrtv]))|(?:[u](?:[\dA-Fa-f]){4})))|(?:\\(\r\n|\r|\n)))*")))/,
      /*  8: */  /^(?:(([-]?(?:[-]?([0]|((?:[1-9])(?:\d+)*)))\.(?:\d+)*)|(\.(?:\d+))|((?:[-]?([0]|((?:[1-9])(?:\d+)*))))))/,
      /*  9: */  /^(?:--([^\n]*))/,
      /* 10: */  /^(?:\$\{)/,
      /* 11: */  /^(?:\$\()/,
      /* 12: */  /^(?:=)/,
