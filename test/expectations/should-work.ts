{  test: true,
  ...
  connections: { main : { connector : require('tenhub-server/connectors/mongodb').connector ,options : { collection : 'websessions' ,autoRemove : 'interval' ,autoRemoveInterval : process.env['AUTO_REMOVE_INTERVAL']  }   }   } ,
