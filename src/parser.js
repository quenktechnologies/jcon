...
case 28:
    ...
    this.$ = new yy.ast.Module(yyvstack[yysp].join(''), this._$);
    break;
...
case 32:
    ...
    this.$ = new yy.ast.Var(yyvstack[yysp - 1], this._$);
    break;
...
parse: function parse(input) {
    ...
    var NO_ACTION = [0, 81 /* === table.length :: ensures that anyone using this new state will fail dramatically! */];
